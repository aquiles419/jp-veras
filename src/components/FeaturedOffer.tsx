...
export function FeaturedOffer({ offer }: FeaturedOfferProps) {
  ...
  return (
    ...
    >
      <div className="relative h-[280px] flex-[1_1_320px] bg-surface-alt">
        {offer.image_url ? (
          <Image
            src={offer.image_url}
            alt=""
        ...
        <div className="absolute left-3.5 top-3.5 flex items-center gap-1 rounded-lg bg-accent px-2.5 py-1.5 text-[11.5px] font-extrabold text-black">
